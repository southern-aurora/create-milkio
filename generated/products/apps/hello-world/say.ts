...
export const params = async (params: any) => ((input: any): typia.IValidation<ParamsT> => { const validate = (input: any): typia.IValidation<ParamsT> => {
    ...
    const __is = (input: any): input is ParamsT => {
        return "object" === typeof input && null !== input && ("string" === typeof (input as any).by && (2 <= (input as any).by.length && (input as any).by.length <= 16));
    };
    if (false === __is(input)) {
        ...
        ((input: any, _path: string, _exceptionable: boolean = true): input is ParamsT => {
            const $vo0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ["string" === typeof input.by && (2 <= input.by.length || $report(_exceptionable, {
                    path: _path + ".by",
                    ...
                    path: _path + ".by",
                    expected: "(string & MinLength<2> & MaxLength<16>)",
                    value: input.by
